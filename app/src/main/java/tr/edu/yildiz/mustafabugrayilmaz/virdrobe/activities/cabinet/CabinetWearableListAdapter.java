...
public class CabinetWearableListAdapter extends ListAdapter<Wearable, CabinetWearableListAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            linearLayout = view.findViewById(R.id.cabinetWearableRowItemLinearLayout);
            imageView = view.findViewById(R.id.cabinetWearableRowItemImageView);
            typeTextView = view.findViewById(R.id.cabinetWearableRowItemTypeTextView);
            colorTextView = view.findViewById(R.id.cabinetWearableRowItemColorTextView);
            patternTextView = view.findViewById(R.id.cabinetWearableRowItemPatternTextView);
            purchaseDateTextView = view.findViewById(R.id.cabinetWearableRowItemPurchaseDateTextView);
            priceTextView = view.findViewById(R.id.cabinetWearableRowItemPriceTextView);
        }
    ...
    public CabinetWearableListAdapter(@NonNull DiffUtil.ItemCallback<Wearable> diffCallback, Context context, ArrayList<Long> pickedList) {
        super(diffCallback);
    ...
    @NonNull
    @Override
    public CabinetWearableListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.cabinet_wearable_row_item, viewGroup, false);

        return new CabinetWearableListAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CabinetWearableListAdapter.ViewHolder viewHolder, int position) {
    ...
    public static class CabinetWearableDiff extends DiffUtil.ItemCallback<Wearable> {
